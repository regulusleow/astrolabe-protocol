...
class RuntimeCancellationModelTest {
    ...
    fun `cancellation fixtures decode through typed contracts`() {
        val request = codec.decodeRequest(fixture("v2/Fixtures/valid/cancel-request.json"))
        val response = codec.decodeResponse(fixture("v2/Fixtures/valid/cancel-response.json"))
