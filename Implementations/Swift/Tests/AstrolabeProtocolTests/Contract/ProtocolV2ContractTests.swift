...
final class ProtocolV2ContractTests: XCTestCase {
    func testV2ContractAssetsCoverEveryMethod() throws {
        ...
        let manifest = try jsonObject(
            at: repositoryURL.appendingPathComponent("Contract/v2/manifest.json")
        )
        ...
        XCTAssertTrue(
            FileManager.default.fileExists(
                atPath: repositoryURL.appendingPathComponent("Contract/v2/PROTOCOL.md").path
            )
        )
        ...
        XCTAssertTrue(
            FileManager.default.fileExists(
                atPath: repositoryURL
                    .appendingPathComponent("Contract/v2/Schemas")
